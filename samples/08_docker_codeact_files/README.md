...
[Sample 14](../14_acas_codeact_files/) is this sample on a real Azure sandbox — same task, same data, same two lines, four lines of wiring different — and one script checks both.
