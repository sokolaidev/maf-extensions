...
| Packaged rule catalogs and trusted diagnostic selection | Implemented for Bicep; Terraform summaries remain outside this change | [#1386](https://github.com/sokolaidev/maf-extensions/issues/1386) (open) |
