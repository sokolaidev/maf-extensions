...
| A guest-OS axis — this kind execs `python3`, and dispatch additionally needs `sh` and `nohup` | open | [#111](https://github.com/sokolaidev/maf-extensions/issues/111) (open) |
