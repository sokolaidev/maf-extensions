...
| Work | State | Tracker |
|---|---|---|
| Offline Terraform/OpenTofu validation, fixed launcher, images, examples, tests, and package registration | implementation under review; package not yet released | [#1246](https://github.com/sokolaidev/maf-extensions/issues/1246) |
| Online dependencies, plan/apply/state commands, variable-dependent initialization, optional policy tools, and warm reuse | outside the first-version scope | scope recorded in [#1246](https://github.com/sokolaidev/maf-extensions/issues/1246) |
