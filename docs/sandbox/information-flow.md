...
| Use the result contract in all four kinds, samples and live checks | Partial; Bicep and Terraform/OpenTofu tools and their live checks, plus draw.io, sample 18 and its checks, use the contract; remaining adoption stays open | Bicep by [#1363](https://github.com/sokolaidev/maf-extensions/pull/1363) (merged); Terraform/OpenTofu by [#1367](https://github.com/sokolaidev/maf-extensions/pull/1367) (merged); draw.io by [#1374](https://github.com/sokolaidev/maf-extensions/pull/1374) (merged); remaining adoption in [#1357](https://github.com/sokolaidev/maf-extensions/issues/1357) (open) |
