...
| A backend serving `RUN_CODE` and `SNAPSHOT` | implemented by [Hyperlight](backends/hyperlight.md) for packaged Python on Windows WHP; optional files and native host tools remain independent follow-ups | [#382](https://github.com/sokolaidev/maf-extensions/issues/382) (open) |
