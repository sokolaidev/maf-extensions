...
| A backend serving `RUN_CODE` and `SNAPSHOT` | implemented by [Hyperlight](backends/hyperlight.md) for packaged Python on Windows WHP and Linux KVM; optional files and native host tools remain independent follow-ups | [#382](https://github.com/sokolaidev/maf-extensions/issues/382) (open); initial runtime delivered by [#1223](https://github.com/sokolaidev/maf-extensions/pull/1223) (merged); Linux validation completed in [#1228](https://github.com/sokolaidev/maf-extensions/issues/1228) (closed) by [#PRNUM](https://github.com/sokolaidev/maf-extensions/pull/PRNUM) (merged) |
