...
| `ATTACHED_IDENTITY` plumbing behind the vocabulary | open — the capability name is this page's; everything behind it is the identity axis, whose body is [`hosts.md`](hosts.md)'s | [#567](https://github.com/sokolaidev/maf-extensions/issues/567), [#568](https://github.com/sokolaidev/maf-extensions/issues/568) and [#566](https://github.com/sokolaidev/maf-extensions/issues/566) (all open), re-cut from [#395](https://github.com/sokolaidev/maf-extensions/issues/395) and [#396](https://github.com/sokolaidev/maf-extensions/issues/396) (both closed) |
