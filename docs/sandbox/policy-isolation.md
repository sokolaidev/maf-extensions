...
| A guest-platform axis a kind can declare and match | open | [#111](https://github.com/sokolaidev/maf-extensions/issues/111) (open) — deliberately unbuilt while every shipped backend runs a Linux guest |
