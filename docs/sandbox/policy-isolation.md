...
| Identity axis remainder — `IdentityScope`, `ATTACHED_IDENTITY` plumbing, the C′ prerequisites | open — the body is [`hosts.md`](hosts.md)'s | [#567](https://github.com/sokolaidev/maf-extensions/issues/567), [#568](https://github.com/sokolaidev/maf-extensions/issues/568) and [#566](https://github.com/sokolaidev/maf-extensions/issues/566) (all open), re-cut from [#395](https://github.com/sokolaidev/maf-extensions/issues/395) and [#396](https://github.com/sokolaidev/maf-extensions/issues/396) (both closed) |
...
| The four `getattr`-read backend declarations collapse into one optional declarations object | open — the count this document named as the trigger has been reached, and the collapse is owed | untracked |
