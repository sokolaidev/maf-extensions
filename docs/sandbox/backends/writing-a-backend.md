...
| Provider path-replacement races | Backend-specific; Docker closes the race by pausing the container, WSLC writes and setup reach nothing past the image's user, ACAS reads retain limits | [#456](https://github.com/sokolaidev/maf-extensions/issues/456) (closed) by [#PR](https://github.com/sokolaidev/maf-extensions/pull/PR) (merged); ACAS reads handed off to [#1336](https://github.com/sokolaidev/maf-extensions/issues/1336) (open); [ACAS](acas.md), [WSLC](wslc.md) |
