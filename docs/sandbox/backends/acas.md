...
| ACAS declares `FILES_DELETE` | shipped — live measurement confirmed final-component and interior links are unlinked without following their targets; symlinked parents remain refused because the service resolves them | [#589](https://github.com/sokolaidev/maf-extensions/issues/589) (open) |
