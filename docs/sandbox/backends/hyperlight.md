...
The consolidated [research record](../research/hyperlight.md) preserves the historical investigation. Its proposed file capabilities are not declarations of this adapter. Optional file work must establish its own conformance and cleanup before any file capability is enabled.
