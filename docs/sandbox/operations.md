...
| ACAS recovery for missing lifecycle policies | implemented — labelled sandboxes missing effective auto-delete are repaired or expired by the ACAS recovery script | [#1011](https://github.com/sokolaidev/maf-extensions/issues/1011) (closed) by [#1022](https://github.com/sokolaidev/maf-extensions/pull/1022) (merged) |
