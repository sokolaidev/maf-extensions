...
7. **Unpack providers at build time.** Verify each unpacked directory's `h1:` hash against the ZIP it came from. Calls then link providers instead of copying them.
