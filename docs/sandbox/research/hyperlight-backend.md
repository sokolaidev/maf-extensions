...
| Pool | Node image | Kernel | containerd | Host `/dev/kvm` |
|---|---|---|---|---|
| Ubuntu 24.04.5 | `AKSUbuntu-2404gen2containerd-202609.15.0` | `6.8.0-1067-azure` | 2.3.3-2 | `0660` root:993 |
| Azure Linux 3.0 | `AKSAzureLinux-V3gen2-202609.15.0` | `6.6.150.1-1.azl3` | 2.2.4 | `0666` root:32 |
