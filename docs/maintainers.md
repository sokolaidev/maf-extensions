...
2. **A sandbox group** in it (→ `ACA_SANDBOX_GROUP`), whose data-plane endpoint (`https://management.<region>.azuredevcompute.io`) is `ACA_SANDBOX_ENDPOINT`. This is what the sample creates its sandbox in.
