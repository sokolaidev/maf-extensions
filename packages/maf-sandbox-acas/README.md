...
The native route remains available to avoid adding shell or interpreter dependencies to file retrieval and enumeration, or withdrawing those capabilities from existing workloads. A host requiring a held filesystem boundary must choose a backend with that guarantee. Atomic confinement requires [service-side support](https://github.com/microsoft/azure-container-apps/issues/1831); [the measured contract and alternatives](https://github.com/sokolaidev/maf-extensions/blob/main/docs/sandbox/backends/acas.md#native-reads-retain-a-confinement-residual) record what is retained here. This is a documented residual, not a claim of atomicity.
