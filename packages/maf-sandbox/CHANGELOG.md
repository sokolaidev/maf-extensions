...
## [0.40.0](https://github.com/sokolaidev/maf-extensions/compare/maf-sandbox-v0.39.0...maf-sandbox-v0.40.0) (2026-09-12)
...
* **sandbox:** the reach rule is stated for the whole file surface, with probes that read what a removal took and what a write left ([#964](https://github.com/sokolaidev/maf-extensions/issues/964))
...
* **sandbox:** the reach rule is stated for the whole file surface, with probes that read what a removal took and what a write left ([#964](https://github.com/sokolaidev/maf-extensions/issues/964)) ([0b71fc4](https://github.com/sokolaidev/maf-extensions/commit/0b71fc45d8456ba834ce156e8384ec09e3dd16e1))
