...
| [`maf-sandbox-tui`](packages/maf-sandbox-tui/) | not yet released | MST, an authenticated local operator console for listing, inspecting and disposing exact physical sandbox generations owned by opted-in MAF applications | `maf-sandbox`, `textual` |
